...
/**
 * Taken from guava: https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/AbstractIterator.java
 *
...
public abstract class AbstractIterator<T> implements Iterator<T> {
	 ...
	 * or {@code next} methods on this instance; if it does, an
